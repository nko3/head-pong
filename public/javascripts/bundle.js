...
require.define("/public/javascripts/jquery.js",function(require,module,exports,__dirname,__filename,process,global){/*! jQuery v1.8.2 jquery.com | jquery.org/license */
...
require.define("/public/camera/jquery.objectdetect.js",function(require,module,exports,__dirname,__filename,process,global){(function($) {
...
require.define("/public/javascripts/mouse.js",function(require,module,exports,__dirname,__filename,process,global){(function() {
  mousex = 100
...
require.define("/public/javascripts/animationFrame.js",function(require,module,exports,__dirname,__filename,process,global){(function() {
    var lastTime = 0;
...
require.define("/public/javascripts/init.js",function(require,module,exports,__dirname,__filename,process,global){(function(){
  socket = io.connect();
...
require.define("/public/javascripts/start.coffee",function(require,module,exports,__dirname,__filename,process,global){(function() {
...
require.define("/public/javascripts/explosion.coffee",function(require,module,exports,__dirname,__filename,process,global){(function() {
  var Explosion;
...
require.define("/lib/shared/puck.coffee",function(require,module,exports,__dirname,__filename,process,global){(function() {
  var Puck;
  ...
  Puck = (function() {
    ...
    Puck.prototype.move = function(paddle1, paddle2) {
      this.x += this.dx;
      this.y += this.dy;
      ...
      if (this.y > global.canvas_height - this.radius) {
        this._reset();
      }
    ...
    Puck.prototype._collidedWith = function(paddle) {
      if (this.x - this.radius < paddle.x + paddle.width / 2 && this.x + this.radius > paddle.x - paddle.width / 2) {
        if ((this.y - this.radius < paddle.y + paddle.height / 2 && this.y > paddle.y) || (this.y + this.radius > paddle.y - paddle.height / 2 && this.y < paddle.y)) {
          return true;
        }
      }
      return false;
...
require.define("/public/javascripts/entry.js",function(require,module,exports,__dirname,__filename,process,global){window.onload = function(){
  require('./jquery')
...
require("/public/javascripts/entry.js");
})();
