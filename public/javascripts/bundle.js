...
require.define("/mouse.js",function(require,module,exports,__dirname,__filename,process,global){(function() {
  mousex = 100
...
require.define("/jquery.js",function(require,module,exports,__dirname,__filename,process,global){/*! jQuery v1.8.2 jquery.com | jquery.org/license */
...
require.define("/init.coffee",function(require,module,exports,__dirname,__filename,process,global){(function() {
  var Paddle, Puck, drawBackground, mainLoop, startGame;
  ...
  startGame = function() {
    ...
    return mainLoop(puck, paddle);
  };

  mainLoop = function(puck, paddle) {
...
require.define("/paddle.coffee",function(require,module,exports,__dirname,__filename,process,global){(function() {
  ...
  Paddle = (function() {
    ...
    Paddle.prototype.draw = function() {
      ...
      return ctx.fillRect(this.x - this.width / 2, this.y - this.width / 2, this.width, this.height);
    };
...
require.define("/puck.coffee",function(require,module,exports,__dirname,__filename,process,global){(function() {
  ...
  Puck = (function() {
    ...
    function Puck(x, y, dx, dy, radius) {
      this.x = x;
      this.y = y;
      this.dx = dx;
      this.dy = dy;
    ...
    Puck.prototype.collide = function(paddle) {
      if (this.x - this.radius < paddle.x + paddle.width / 2 && this.x + this.radius > paddle.x - paddle.width / 2) {
        if (this.y - this.radius < paddle.y + paddle.height / 2 && this.y > paddle.height / 2) {
          this.dy *= -1;
          this.y = paddle.y + this.radius + paddle.height / 2;
        }
        if (this.y + this.radius > paddle.y + paddle.height / 2 && this.y < paddle.height / 2) {
          this.dy *= -1;
          return this.y = paddle.y - this.radius - paddle.height / 2;
        }
      }
    };
