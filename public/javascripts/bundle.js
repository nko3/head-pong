...
require.define("/socket.js",function(require,module,exports,__dirname,__filename,process,global){(function(){
  socket = io.connect();
  ...
  Puck = (function() {
    ...
    Puck.prototype.move = function() {
      ...
      if (this.collidedWith(paddle1)) {
        ...
        this.y = paddle1.y + paddle1.height / 2 + this.radius;
      }
      if (this.collidedWith(paddle2)) {
